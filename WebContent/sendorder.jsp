...
<%
	...
	try{
		...
		for(int i=0;i<itemname.length;i++) {
	    	rs1=st.executeQuery(getid);
    		if(rs1.next()) { val=rs1.getInt(1);
		   ...
		   out.println("<center><h3 style='color:ivory;border:1px solid gray;background:maroon;font-size:15px;width:500px;height:60px'>Mr/Mrs. "+session.getValue("login")+" Thank U For Ordering.<BR>We Will Send it To Ur Home with in a week</center></h3><BR><center><a href='user.jsp'>Continue</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='javascript:parent.close()'>Close</a></center>");
			...
			out.println("<link rel=stylesheet href='cyber.css'><body bgcolor=ivory><h1>Error Occured! While Processing Ur Transaction</font></h1><P>"+msgs+"</p><br><br><center><a href=\"user.jsp\">Continue</a><BR>"+e);
    	}  
%>		
</body></html>
