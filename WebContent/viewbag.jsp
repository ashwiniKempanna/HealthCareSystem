...
<title>Healthcare Shoppinge</title>
<style>
...
<body>
<jsp:include page="user_transactions.jsp" /><br>
<center><h3 style="color: black; text-decoration: underline; ">Cart</h3></center><br>
<%
    String buff="";
	String head="";
    Connection con=null;
...
<tr>
  ...
  <tr>
    ...
    <td colspan="3"><select style="font-size: small;" name="cctype">
  ...
  <tr>
    ...
    <td width="15%"><select style="font-size: small;" name="dd">
      <option>dd</option>
    ...
    <td width="11%"><select style="font-size: small;" name="mm">
      <option>mm</option>
      <option value="01">01</option>
      <option value="02">02</option>
      <option value="03">03</option>
    ...
    <td width="24%"><select style="font-size: small;" name="yyyy">
      <option>year</option>
