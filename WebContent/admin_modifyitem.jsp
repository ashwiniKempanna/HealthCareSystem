...
<BR>
<BR>
<BR><center><h3 style="color: black; text-decoration: underline; ">Modify Existing Product</h3></center><br><br>
<table align=center cellspacing=1 cellpadding=3><form method=post action="admin_modifyitemupdate.jsp">
<tr><td>Category:</td><td><input readonly value="<%=table%>" name=category></td></tr>
...
<%
	...
	String cmd="Select * from product where CATEGORYNAME='"+table+"'";
	...
	while(rs.next()) {
		...
		out.println("<option desc='"+desc+"' cost='"+cost+"' value='"+name+"'>"+name+"</option>");
	}
   }   catch(Exception e) {
...
<tr><TD align=right>Description:</td><Td><input name=description></td></tr>
<tr><TD align=right>Price:</td><Td><input name=cost></td></tr>
